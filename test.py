#coding=utf-8
from Mymmseg import Analysis, cuttest



# file1 = open("sougou.txt", 'r', encoding='utf-8')
# file2 = open("seg.txt", 'w', encoding='utf-8')
# text = file1.read()
# sentences = text.split('。')
# tmp = ""
# for sentence in sentences:
#     # text = "市场经济中国有企业才能发展"
#     wlist = [word for word in Analysis(sentence)]
#     for w in wlist:
#         tmp += w
#     tmp += '\n'
# file2.write(tmp)
...
print("交叉歧义：")
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
cuttest(u"市场经济中国有企业才能发展")
cuttest(u"美国会通过对台售武法案")
cuttest(u"乒乓球拍卖完了")
cuttest(u"结合成分子")
print("组合歧义：")
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
cuttest(u"这个门的把手坏了好几天了")
cuttest(u"那本书写得非常精彩")
cuttest(u"他年纪不大鬼点子却不少")
cuttest(u"小王炒菜的手艺不错")